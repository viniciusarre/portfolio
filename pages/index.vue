<template>
  <v-layout
    ...
    align-center
  >
    <v-img class="mb-5 hidden-md-and-down" src="/logo.png" lazy-src="" max-width="20vw" max-height="auto" />
      ...
      <v-card outlined>
        ...
        <v-card-text>
          ...
          <p>
            ...
            <span class="ml-3">
              <a target="__blank" href="https://www.linkedin.com/in/vin%C3%ADcius-arr%C3%A9-08732b131/"><v-icon>mdi-linkedin</v-icon></a>
            </span>
            <span class="ml-3">
              <a target="__blank" href="https://twitter.com/arre_dev"><v-icon>mdi-twitter</v-icon></a>
            </span>
          </p>
        </v-card-text>
      </v-card>
